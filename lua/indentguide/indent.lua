...
---@enum indentguide.indent.whitespace
M.whitespace = {
    TAB_START = 1,
    TAB_START_SINGLE = 2,
    TAB_FILL = 3,
...
---@class indentguide.indent_state
---@field cap boolean
---@field stack table<number, number>?

---@class indentguide.indent_options
---@field smart_indent_cap boolean
---@field shiftwidth number
---@field tabstop number
---@field vartabstop string

--- Takes the whitespace of a line and returns a list of indentguide.indent.whitespace
---
---@param whitespace string
---@param opts indentguide.indent_options
---@param indent_state indentguide.indent_state?
---@return indentguide.indent.whitespace[], indentguide.indent_state
...
---
---@param whitespace indentguide.indent.whitespace
