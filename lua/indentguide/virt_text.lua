...
---@alias indentguide.virtual_text { [1]: string, [2]: string|string[] }[]
---@alias indentguide.char_map { [indentguide.indent.whitespace]: string|string[] }
...
---@param listchars indentguide.listchars
---@param whitespace_only boolean
---@param blankline boolean
---@return indentguide.char_map
...
---@param config indentguide.config
---@param char_map indentguide.char_map
---@param whitespace_tbl indentguide.indent.whitespace[]
---@param scope_active boolean
---@param scope_index number
---@param scope_end boolean
---@param scope_col_start_single number
---@return indentguide.virtual_text, indentguide.highlight
